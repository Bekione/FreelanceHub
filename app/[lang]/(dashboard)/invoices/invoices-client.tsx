...
export function InvoicesContent({
  ...
  const markingPaidId = markPaidMutation.isPending
            ...
            {!isPro && invoicesMeta && (
              <div className="hidden sm:flex flex-col items-end gap-1">
                <span className="text-xs text-muted-foreground">
                  {totalInvoices} / {FREE_LIMITS.invoicesPerMonth}{" "}
                  {t("invoices.usedOf")}
                </span>
                    ...
                    invoices.map((invoice) => (
                      ...
                      >
                        ...
                        <TableCell>
                          ...
                          >
                            {t(
                              `invoices.status_values.${invoice.status}` as any,
                            )}
                          </Badge>
                        </TableCell>
                        <TableCell className="text-muted-foreground text-sm">
                            ...
                            <Button
                              ...
                              onClick={() => {
                                const locale =
                                  ...
                                  "en";
                                window.open(
                                  `/${locale}/invoices/${invoice.id}/print`,
                                  "_blank",
                                );
                              }}
                            >
