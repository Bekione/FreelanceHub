...
export function OnboardingContent({ dict, lang }: OnboardingContentProps) {
  const t = createT(dict);
  const { data: session } = useSession();
  const router = useRouter();
  const { setTheme } = useTheme();

  // ROLES: id is the English value sent to the API, icon is the visual
  const ROLES = [
    { id: "Web Development", labelKey: "onboarding.roles.webDev", icon: Code2 },
    { id: "Mobile App Dev", labelKey: "onboarding.roles.mobileDev", icon: Smartphone },
    { id: "UI/UX Design", labelKey: "onboarding.roles.uiux", icon: PenTool },
    { id: "Marketing", labelKey: "onboarding.roles.marketing", icon: Megaphone },
    { id: "Writing & Translation", labelKey: "onboarding.roles.writing", icon: FileText },
    { id: "Video & Animation", labelKey: "onboarding.roles.video", icon: Video },
    { id: "Consulting", labelKey: "onboarding.roles.consulting", icon: Briefcase },
    { id: "Other", labelKey: "onboarding.roles.other", icon: MoreHorizontal },
  ];

  const COMPANY_SIZES = [
    { id: "Full-time Freelancing", labelKey: "onboarding.goals.fulltime", icon: Briefcase },
    { id: "Side Hustle", labelKey: "onboarding.goals.sideHustle", icon: Moon },
    { id: "Growing an Agency", labelKey: "onboarding.goals.agency", icon: Users },
    { id: "Just exploring", labelKey: "onboarding.goals.exploring", icon: Search },
  ];
          ...
          <AnimatePresence mode="wait" custom={direction}>
            ...
            {step === 3 && (
              ...
              >
                ...
                >
                  {t("onboarding.finish")} <ArrowRight className="ml-2 h-4 w-4" />
                </Button>
              </motion.div>
            )}
            ...
            {step === 4 && (
              ...
              >
                ...
                <p className="text-muted-foreground">{t("onboarding.justAMoment")}</p>
              </motion.div>
            )}
          </AnimatePresence>
        </div>
